...
[![Windows Build Status](https://ci.appveyor.com/api/projects/status/github/mdsumner/bgmfiles?branch=master&svg=true)](https://ci.appveyor.com/project/mdsumner/bgmfiles)
